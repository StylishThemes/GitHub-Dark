module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        'string-replace': {
            ...
            mark: {
                files: {
                    'github-dark.min.css' : 'github-dark.css',
                },
                options: {
                    replacements: [{
                        pattern     : /\/\*\[\[/gm,
    ...
    // Minify while keeping userstyles.org comments
    grunt.registerTask('minify', ['string-replace:mark', 'cssmin:minify', 'string-replace:unmark']);
