...
To retrieve all GitHub styles, a login session is needed unfortunately. Create a dummy GitHub account and set the following environment variables which the build script will use to log in:
